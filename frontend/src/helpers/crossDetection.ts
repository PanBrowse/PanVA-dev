...
const compareOrder = (currentSequence: number[], reference: number[]) => {
    const homologyGroupsWithOrderChanges:number[] = []
...
const orderIsTheSame = (current: number[], reference: number[], currentIndex: number, referenceIndex: number) =>{
